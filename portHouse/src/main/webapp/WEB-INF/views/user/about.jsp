				...
				<div class="sub_container">
					...
					<div class="about">
						<p class="content">
							...
							<span>웹 에이전시에서 퍼블리셔</span>로서 실무경력을 쌓았으며, 현재는 실무에서 익혔던 HTML, CSS, JavaScript를 기반으로 프론트엔드 개발을 위해 <span>자바스크립트 프레임워크를 공부</span>하고 있습니다.<br />
						</p>
						<p class="content">
							백엔드에서 많이 사용하고 있는 <span>자바</span> 언어로 프로그래밍에 입문하여 4개월의 <span>프로젝트 참여</span>경험이 있습니다.<br />
							자바의 객체지향 프로그래밍 개념과 경험은 프론트엔드 개발언어를 공부할 때에도 큰 도움이 되고 있습니다.<br />
						</p>
						<p class="content">
						...
						<p class="content">
							하나의 소프트웨어를 만들기 위해서는 기획, 디자인, 개발 각 분야의 전문가들과 함께 <span>협업</span>하여 클라이언트의 요구에 부응하는 최적의 결과물에 도달할 수 있도록 <span>함께</span> 노력해야한다고 생각합니다.<br />
						</p>
						<p class="content">
